      ...
      <div className="min-h-[calc(100vh-160px)] flex flex-col items-center justify-center py-12 px-4 select-none animate-in fade-in duration-300">
        <div className="max-w-xl w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 shadow-elevated text-center relative overflow-hidden space-y-6">
          ...
          <div className="space-y-2">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold bg-purple-50 dark:bg-purple-950/60 text-purple-600 dark:text-purple-300 border border-purple-200 dark:border-purple-800">
              <Clock className="w-3.5 h-3.5" />
              <span>Status: Coming Soon</span>
            </div>

            <h1 className="text-[11px] font-extrabold text-slate-900 dark:text-white tracking-tight">
          ...
          <div className="bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/80 rounded-xl p-5 text-[11px] space-y-2 text-left">
          ...
          <div className="pt-2">
            <button
              onClick={onBack}
              className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold text-[11px] px-6 py-3 rounded-xl shadow-md shadow-blue-600/20 transition-all hover:scale-105"
            >
    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-soft flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="w-20 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-1.5 text-[11px] font-bold text-blue-600 text-center outline-none focus:border-blue-600"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-[11px] px-4 py-2 rounded-xl shadow-md shadow-blue-600/20 transition-all"
          >
                ...
                <tr key={obs.obsNo} className="hover:bg-slate-50/60 dark:hover:bg-slate-800/40 transition-colors">
                  ...
                  <td className="p-3">
                    <input
                      ...
                      className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg px-2.5 py-1 text-[11px] font-semibold text-blue-600 dark:text-blue-400 outline-none focus:border-blue-600 w-full"
                    />
                  </td>
                  <td className="p-3">
                    <input
                      ...
                      className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg px-2.5 py-1 text-[11px] outline-none focus:border-blue-600 w-full"
                    />
                  </td>
                  <td className="p-3">
                    <input
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-7 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-soft space-y-3">
          <h4 className="text-[11px] font-bold text-slate-900 dark:text-white uppercase tracking-wider border-b border-slate-100 dark:border-slate-800 pb-2">
            Observation Summary
          </h4>
