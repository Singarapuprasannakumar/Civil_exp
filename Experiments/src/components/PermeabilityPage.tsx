    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-soft space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-[11px] font-semibold text-slate-600 dark:text-slate-300">Specimen Diameter (cm)</label>
            <input
              type="number"
              step="0.1"
              value={specimenD}
          ...
          <div className="flex flex-col gap-1">
            <label className="text-[11px] font-semibold text-slate-600 dark:text-slate-300">Specimen Length (cm)</label>
            <input
              type="number"
              step="0.01"
              value={specimenL}
          ...
          <div className="flex flex-col gap-1">
            <label className="text-[11px] font-semibold text-slate-600 dark:text-slate-300">Specific Gravity (G)</label>
            <input
              type="number"
              step="0.01"
              value={gravityG}
          ...
          <div className="flex flex-col gap-1">
            <label className="text-[11px] font-semibold text-slate-600 dark:text-slate-300">Mass of Empty Mould (g)</label>
            <input
              type="number"
              step="0.1"
              value={mouldEmpty}
          ...
          <div className="flex flex-col gap-1">
            <label className="text-[11px] font-semibold text-slate-600 dark:text-slate-300">Temperature (°C)</label>
            <input
              type="number"
              step="0.5"
              value={temperature}
              onChange={(e) => setTemperature(parseFloat(e.target.value) || 27)}
              className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-[11px] font-bold text-amber-600 outline-none focus:border-teal-600"
            />
          </div>

          <div className="flex flex-col gap-1">
            <label className="text-[11px] font-semibold text-slate-600 dark:text-slate-300">Number of Observations</label>
            <input
              type="number"
              min="1"
              max="20"
              ...
              className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-[11px] font-bold text-slate-900 dark:text-white outline-none focus:border-teal-600 text-center"
            />
          </div>
          ...
          <div className="flex items-end">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-teal-600 hover:bg-teal-700 text-white font-bold text-[11px] py-2.5 rounded-xl shadow-md shadow-teal-600/20 transition-all hover:scale-102"
            >
      ...
      <div className="bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-xl p-5 shadow-soft space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 text-[11px]">
          ...
          <div className="p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
            ...
            <code className="text-[11px] font-bold text-teal-600 dark:text-teal-400 font-mono block mt-1">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-soft space-y-4">
        <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
          ...
          <div className="flex items-center gap-2 text-[11px] font-bold text-teal-600 bg-teal-50 dark:bg-teal-950 px-3 py-1 rounded-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          ...
          <div className="md:col-span-5 bg-teal-50/90 dark:bg-teal-950/50 border border-teal-200 dark:border-teal-900/60 rounded-xl p-6 flex flex-col justify-center text-center shadow-soft">
            ...
            <span className="text-4xl font-extrabold text-teal-600 dark:text-teal-400 mt-2">
              {formatScientific(avgK27)} <span className="text-[11px] font-semibold">cm/sec</span>
            </span>
