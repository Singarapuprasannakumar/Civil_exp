      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <h1 className="text-[11px] font-bold text-slate-900">Direct Shear Test</h1>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-200">
          <div className="flex justify-between items-start">
            <div>
              <h2 className="text-[11px] font-semibold text-slate-800">Experiment 13: Direct Shear Test</h2>
              <p className="text-slate-500 mt-1">IS 2720 Part 13</p>
            </div>
            <div className="bg-blue-50 text-blue-700 px-3 py-1 rounded-full text-[11px] font-medium">
              Geotechnical
            </div>
          </div>
        ...
        {/* Test Information */}
        <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-200">
          <h3 className="text-[11px] font-semibold text-slate-800 mb-4 flex items-center">
            <Calculator className="w-5 h-5 mr-2 text-blue-600" />
            Test Information
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div>
              <label className="block text-[11px] font-medium text-slate-700 mb-1">Registration No.</label>
              <input
                type="text"
                name="regdNo"
            ...
            <div>
              <label className="block text-[11px] font-medium text-slate-700 mb-1">Least Count (mm/div)</label>
              <input
                type="number"
                name="lch"
                step="0.01"
            ...
            <div>
              <label className="block text-[11px] font-medium text-slate-700 mb-1">Proving Ring Constant (kN/div)</label>
              <input
                type="number"
                name="pc"
                step="0.01"
            ...
            <div>
              <label className="block text-[11px] font-medium text-slate-700 mb-1">Length, L (mm)</label>
              <input
                type="number"
                name="L"
                step="0.1"
            ...
            <div>
              <label className="block text-[11px] font-medium text-slate-700 mb-1">Breadth, B (mm)</label>
              <input
                type="number"
                name="B"
                step="0.1"
            ...
            <div>
              <label className="block text-[11px] font-medium text-slate-700 mb-1">Depth, D (mm)</label>
              <input
                type="number"
                name="D"
                step="0.1"
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-200">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-[11px] font-semibold text-slate-800">Observation Table</h3>
            <div className="flex space-x-3">
              ...
              <button
                ...
                className="flex items-center px-3 py-2 text-[11px] font-medium text-slate-700 bg-white border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center px-3 py-2 text-[11px] font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors"
              >
        ...
        {/* Calculation Details */}
        <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-200">
          <h3 className="text-[11px] font-semibold text-slate-800 mb-4">Calculation Details</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 text-[11px] text-slate-600 bg-slate-50 p-4 rounded-lg">
          ...
          <div className="overflow-x-auto max-h-96">
            <table className="w-full text-[11px] text-left">
              <thead className="text-[11px] text-slate-700 uppercase bg-slate-50 sticky top-0">
                <tr>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-200">
            <h3 className="text-[11px] font-semibold text-slate-800 mb-4">Specimen Graph</h3>
            <div className="h-80">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-200">
            <h3 className="text-[11px] font-semibold text-slate-800 mb-4">Failure Envelope</h3>
        ...
        <div className="bg-blue-600 rounded-xl shadow-sm p-6 text-white">
          <h3 className="text-[11px] font-semibold mb-6 opacity-90">Final Results</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-blue-700/50 rounded-lg p-6 border border-blue-500/30">
              <div className="text-blue-200 text-[11px] mb-2">Cohesion, c</div>
              <div className="text-4xl font-bold">
                {calculatedData.c.toFixed(3)} <span className="text-[11px] font-normal opacity-80">kPa</span>
              </div>
            </div>
            <div className="bg-blue-700/50 rounded-lg p-6 border border-blue-500/30">
              <div className="text-blue-200 text-[11px] mb-2">Angle of Shearing Resistance, φ</div>
              <div className="text-4xl font-bold">
                {calculatedData.phi.toFixed(3)} <span className="text-[11px] font-normal opacity-80">°</span>
              </div>
            </div>
          </div>
        </div>
