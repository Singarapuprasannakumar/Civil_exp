        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
          ...
          <div className="flex flex-col gap-1">
            ...
            <select
              ...
              className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-[11px] font-bold text-teal-600 outline-none focus:border-teal-600 cursor-pointer"
            >
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              readOnly
              value={GL.toFixed(4)}
              className="bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-[11px] font-bold text-teal-600 cursor-not-allowed"
            />
          </div>
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-teal-600 hover:bg-teal-700 text-white font-bold text-[11px] py-2.5 rounded-xl shadow-md shadow-teal-600/20 transition-all hover:scale-102"
          >
          ...
          <div className="md:col-span-7 space-y-2">
            {observations.map((obs) => (
              ...
              >
                ...
                <span className="font-bold text-teal-600 dark:text-teal-400 text-[11px]">
