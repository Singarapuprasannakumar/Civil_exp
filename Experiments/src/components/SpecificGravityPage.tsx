        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
          ...
          <div className="flex flex-col gap-1">
            ...
            <select
              ...
              className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-sm font-bold text-teal-600 outline-none focus:border-teal-600 cursor-pointer"
            >
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              readOnly
              value={GL.toFixed(4)}
              className="bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-sm font-bold text-teal-600 cursor-not-allowed"
            />
          </div>
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-teal-600 hover:bg-teal-700 text-white font-bold text-sm py-2.5 rounded-xl shadow-md shadow-teal-600/20 transition-all hover:scale-102"
          >
      ...
      <div className="bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-xl p-5 shadow-soft space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-3 text-sm">
          <div className="p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
            <span className="font-semibold text-slate-500 dark:text-slate-400 block text-sm">Weight of Soil</span>
          ...
          <div className="p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
            <span className="font-semibold text-slate-500 dark:text-slate-400 block text-sm">Water Filling Pycnometer</span>
            <code className="text-sm font-bold text-blue-600 dark:text-blue-400 font-mono block mt-1">
              = W4 − W1
            </code>
          </div>
          ...
          <div className="p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
            <span className="font-semibold text-slate-500 dark:text-slate-400 block text-sm">Water Above Soil</span>
            <code className="text-sm font-bold text-blue-600 dark:text-blue-400 font-mono block mt-1">
              = W3 − W2
            </code>
          </div>
          ...
          <div className="p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
            <span className="font-semibold text-slate-500 dark:text-slate-400 block text-sm">Gt (@ {temp}°C)</span>
          ...
          <div className="p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
            <span className="font-semibold text-slate-500 dark:text-slate-400 block text-sm">G27 (@ 27°C)</span>
            <code className="text-sm font-bold text-teal-600 dark:text-teal-400 font-mono block mt-1">
              = (Gt × GL) ÷ G27Water
            </code>
          </div>
