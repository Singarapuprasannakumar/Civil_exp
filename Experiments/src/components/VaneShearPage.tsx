        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-[11px] font-bold text-slate-900 dark:text-white tracking-tight flex items-center gap-3">
              ...
              <span className="text-[11px] font-semibold bg-red-50 dark:bg-red-950 text-red-600 dark:text-red-400 px-2.5 py-1 rounded-full border border-red-200 dark:border-red-800 flex items-center gap-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-[11px] font-semibold text-slate-900 dark:text-white outline-none focus:border-red-600"
            />
          </div>

          <div className="flex flex-col gap-1">
            <label className="text-[11px] font-semibold text-slate-600 dark:text-slate-300">Vane Diameter d (cm)</label>
            <input
              type="number"
              step="0.1"
              value={vaneD}
              onChange={(e) => setVaneD(parseFloat(e.target.value) || 3.8)}
              className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-[11px] font-bold text-blue-600 outline-none focus:border-red-600"
            />
          </div>

          <div className="flex flex-col gap-1">
            <label className="text-[11px] font-semibold text-slate-600 dark:text-slate-300">Vane Height H (cm)</label>
            <input
              type="number"
              step="0.1"
              value={vaneH}
          ...
          <div className="flex flex-col gap-1">
            <label className="text-[11px] font-semibold text-slate-600 dark:text-slate-300">Spring Constant K (kg-cm/°)</label>
            <input
              type="number"
              step="0.1"
              value={springK}
              onChange={(e) => setSpringK(parseFloat(e.target.value) || 2.0)}
              className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-[11px] font-bold text-red-600 outline-none focus:border-red-600"
            />
          </div>

          <div className="flex flex-col gap-1">
            <label className="text-[11px] font-semibold text-slate-600 dark:text-slate-300">Observations</label>
            <input
              type="number"
              min="1"
              max="20"
              ...
              className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-[11px] font-bold text-slate-900 dark:text-white outline-none focus:border-red-600 text-center"
            />
          </div>
        </div>
      </div>
                  ...
                  <tr key={obs.obsNo} className="hover:bg-slate-50/60 dark:hover:bg-slate-800/40 transition-colors">
                    ...
                    <td className="p-2">
                      <input
                        ...
                        className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg px-2.5 py-1 text-[11px] outline-none focus:border-red-600 w-full shadow-inner"
                      />
                    </td>
                    ...
                    <td className="p-2 border-r border-slate-100 dark:border-slate-800">
                      <input
                        ...
                        className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg px-2.5 py-1 text-[11px] font-semibold text-blue-600 outline-none focus:border-red-600 w-full shadow-inner"
                      />
                    </td>
      ...
      <div className="bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-xl p-5 shadow-soft space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-[11px]">
          <div className="p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
            ...
            <code className="text-[11px] font-bold text-blue-600 font-mono block mt-1">= θ2 − θ1</code>
          </div>

          <div className="p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
            <span className="font-semibold text-slate-500 block text-[11px]">Torque (T)</span>
            <code className="text-[11px] font-bold text-blue-600 font-mono block mt-1">= K × Δθ × (π / 180) kg-cm</code>
          </div>

          <div className="p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
            <span className="font-semibold text-slate-500 block text-[11px]">Shear Strength (τf)</span>
            <code className="text-[11px] font-bold text-red-600 font-mono block mt-1">= T / [π · d² · (H/2 + d/6)] kg/cm²</code>
          </div>
        </div>
      </div>
          ...
          <div className="md:col-span-6 grid grid-cols-2 gap-4">
            <div className="bg-blue-50/90 dark:bg-blue-950/50 border border-blue-200 dark:border-blue-900/60 rounded-xl p-5 text-center shadow-soft">
              ...
              <span className="text-4xl font-extrabold text-blue-600 dark:text-blue-400 mt-2 block">
                {avgTorque.toFixed(4)} <span className="text-[11px] font-semibold">kg-cm</span>
              </span>
            </div>
            ...
            <div className="bg-red-50/90 dark:bg-red-950/50 border border-red-200 dark:border-red-900/60 rounded-xl p-5 text-center shadow-soft">
              ...
              <span className="text-4xl font-extrabold text-red-600 dark:text-red-400 mt-2 block">
                {avgShear.toFixed(6)} <span className="text-[11px] font-semibold">kg/cm²</span>
              </span>
            </div>
          </div>
